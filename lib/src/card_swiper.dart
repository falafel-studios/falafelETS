...
import 'package:falafel_ets/src/allowed_swipe_direction.dart';
import 'package:falafel_ets/src/card_animation.dart';
import 'package:falafel_ets/src/card_swiper_controller.dart';
import 'package:falafel_ets/src/enums.dart';
import 'package:falafel_ets/src/extensions.dart';
import 'package:falafel_ets/src/typedefs.dart';
import 'package:falafel_ets/src/undoable.dart';
...
class _CardSwiperState<T extends Widget> extends State<CardSwiper>
  ...
  Widget _frontItem(BoxConstraints constraints) {
    return Positioned(
      ...
      child: Stack( children: [Container(color: Colors.grey,),GestureDetector(
          ...
          child: ConstrainedBox(
            ...
            child:
              ...
              (100 * _cardAnimation.top / widget.threshold).ceil(),
                  _cardAnimation.left>=0?math.min(_cardAnimation.left/widget.threshold, 1):math.max(_cardAnimation.left/widget.threshold, -1)
            ),
          ),
        ),
        onTap: () async {
      ...
      child: Transform.scale(
        ...
        child: ConstrainedBox(
          ...
          child: Card(
            ...
            image: AssetImage(
              'images/falafel.png',
              // You can customize the width, height, and fit properties as needed.
